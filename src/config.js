...
export const DB_USER = process.env.DB_USER || 'joseth';
export const DB_PASSWORD = process.env.DB_PASSWORD || 'josethgatica';
...
export const DB_USER2 = process.env.DB_USER2 || 'joseth';
export const DB_PASSWORD2 = process.env.DB_PASSWORD2 || 'josethgatica';
